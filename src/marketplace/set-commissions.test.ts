...
describe('setCommissions', () => {
  ...
  it('should call setCommissions successfully', async () => {
    ...
    const result = await setCommissions(mockConfig, request);
