import {getPaymentAllocations} from './get-payment-allocations';
...
describe('getPaymentAllocations', () => {
  ...
  it('should call getPaymentAllocations successfully', async () => {
    ...
    const result = await getPaymentAllocations(mockConfig, 'test-id');
