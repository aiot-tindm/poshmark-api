import { reviewPromotion } from './review-promotion';
...
describe('reviewPromotion', () => {
  ...
  it('should call reviewPromotion successfully', async () => {
    ...
    const result = await reviewPromotion(mockConfig, 'test-id', request);
