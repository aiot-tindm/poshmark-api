...
describe('uploadPromotionItems', () => {
  ...
  it('should call uploadPromotionItems successfully', async () => {
    ...
    const result = await uploadPromotionItems(mockConfig, request);
