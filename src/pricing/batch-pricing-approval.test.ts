...
describe('batchPricingApproval', () => {
  ...
  it('should call batchPricingApproval successfully', async () => {
    ...
    const result = await batchPricingApproval(mockConfig, request);
