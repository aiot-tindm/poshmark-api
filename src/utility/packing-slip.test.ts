import {createPackingSlip} from './create-packing-slip';
...
describe('createPackingSlip', () => {
  ...
  it('should call createPackingSlip successfully', async () => {
    ...
    const result = await createPackingSlip(mockConfig, request);
