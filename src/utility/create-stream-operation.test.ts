import {createStreamOperation} from './create-stream-operation';
...
describe('createStreamOperation', () => {
  ...
  it('should call createStreamOperation successfully', async () => {
    ...
    const result = await createStreamOperation(mockConfig, 'test-id', request);
