...
describe('getSupplierCalendars', () => {
  ...
  it('should call getSupplierCalendars successfully', async () => {
    ...
    const result = await getSupplierCalendars(mockConfig);
