...
describe('setTradingPartner', () => {
  ...
  it('should call setTradingPartner successfully', async () => {
    ...
    const result = await setTradingPartner(mockConfig, request);
