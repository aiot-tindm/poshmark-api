...
describe('batchSmallCatalog', () => {
  ...
  it('should call batchSmallCatalog successfully', async () => {
    ...
    const result = await batchSmallCatalog(mockConfig, request);
