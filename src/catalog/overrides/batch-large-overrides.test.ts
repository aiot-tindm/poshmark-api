...
describe('batchLargeOverrides', () => {
  ...
  it('should call batchLargeOverrides successfully', async () => {
    ...
    const result = await batchLargeOverrides(mockConfig, request);
