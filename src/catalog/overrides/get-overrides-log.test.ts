...
describe('getOverridesLog', () => {
  ...
  it('should call getOverridesLog successfully', async () => {
    ...
    const result = await getOverridesLog(mockConfig);
