...
describe('batchSmallOverrides', () => {
  ...
  it('should call batchSmallOverrides successfully', async () => {
    ...
    const result = await batchSmallOverrides(mockConfig, request);
