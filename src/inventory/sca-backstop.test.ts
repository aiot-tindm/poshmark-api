...
describe('scaBackstop', () => {
  ...
  it('should call scaBackstop successfully', async () => {
    ...
    const result = await scaBackstop(mockConfig, request);
