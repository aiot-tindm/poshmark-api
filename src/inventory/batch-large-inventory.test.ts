...
describe('batchLargeInventory', () => {
  ...
  it('should call batchLargeInventory successfully', async () => {
    ...
    const result = await batchLargeInventory(mockConfig, request);
