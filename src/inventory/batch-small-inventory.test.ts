...
describe('batchSmallInventory', () => {
  ...
  it('should call batchSmallInventory successfully', async () => {
    ...
    const result = await batchSmallInventory(mockConfig, request);
