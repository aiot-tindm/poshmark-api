...
describe('batchAssortmentItems', () => {
  ...
  it('should call batchAssortmentItems successfully', async () => {
    ...
    const result = await batchAssortmentItems(mockConfig, 'test-id', request);
