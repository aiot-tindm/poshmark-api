...
describe('addItemToAssortment', () => {
  ...
  it('should call addItemToAssortment successfully', async () => {
    ...
    const result = await addItemToAssortment(mockConfig, 'test-id', request);
