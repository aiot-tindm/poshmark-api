...
describe('getAssortmentLog', () => {
  ...
  it('should call getAssortmentLog successfully', async () => {
    ...
    const result = await getAssortmentLog(mockConfig);
