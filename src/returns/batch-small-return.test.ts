...
describe('batchSmallReturn', () => {
  ...
  it('should call batchSmallReturn successfully', async () => {
    ...
    const result = await batchSmallReturn(mockConfig, request);
