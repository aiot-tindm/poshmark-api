...
describe('batchLargeOrder', () => {
  ...
  it('should call batchLargeOrder successfully', async () => {
    ...
    const result = await batchLargeOrder(mockConfig, request);
