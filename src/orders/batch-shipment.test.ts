...
describe('batchShipment', () => {
  ...
  it('should call batchShipment successfully', async () => {
    ...
    const result = await batchShipment(mockConfig, request);
