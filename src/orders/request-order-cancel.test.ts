import { requestOrderCancel } from './request-order-cancel';
...
describe('requestOrderCancel', () => {
  ...
  it('should call requestOrderCancel successfully', async () => {
    ...
    const result = await requestOrderCancel(mockConfig, request);
