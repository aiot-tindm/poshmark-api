...
describe('batchCancelItems', () => {
  ...
  it('should call batchCancelItems successfully', async () => {
    ...
    const result = await batchCancelItems(mockConfig, request);
