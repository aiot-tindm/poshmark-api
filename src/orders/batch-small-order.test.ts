...
describe('batchSmallOrder', () => {
  ...
  it('should call batchSmallOrder successfully', async () => {
    ...
    const result = await batchSmallOrder(mockConfig, request);
