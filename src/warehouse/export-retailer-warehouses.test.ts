...
describe('exportRetailerWarehouses', () => {
  ...
  it('should call exportRetailerWarehouses successfully', async () => {
    ...
    const result = await exportRetailerWarehouses(mockConfig);
