import { getDeliveryPromise } from './get-delivery-promise';
...
describe('getDeliveryPromise', () => {
  ...
  it('should call getDeliveryPromise successfully', async () => {
    ...
    const result = await getDeliveryPromise(mockConfig, request);
