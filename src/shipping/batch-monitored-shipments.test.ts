...
describe('batchMonitoredShipments', () => {
  ...
  it('should call batchMonitoredShipments successfully', async () => {
    ...
    const result = await batchMonitoredShipments(mockConfig, request);
