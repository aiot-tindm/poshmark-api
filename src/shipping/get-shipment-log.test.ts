...
describe('getShipmentLog', () => {
  ...
  it('should call getShipmentLog successfully', async () => {
    ...
    const result = await getShipmentLog(mockConfig);
