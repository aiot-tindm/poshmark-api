 ...
 */
export declare const ReturnKeyC: t.StringC;
export type ReturnKey = t.TypeOf<typeof ReturnKeyC>;
/**
 * Return status
 */
export declare const ReturnStatusC: t.UnionC<[t.LiteralC<"pending">, t.LiteralC<"approved">, t.LiteralC<"rejected">, t.LiteralC<"completed">, t.LiteralC<"cancelled">]>;
